            ...
            <div class="container-data-img-revisar">
              <div class="data-container">
                ...
                <strong>Descripciones</strong>
                  <input class="p-revisar" :value="interpretacion" readonly />
                  <textarea class="textarea-revisar" :value="desccalidad + desc" rows="10"></textarea>
                  <br>
              </div>
...
export default {
  props: [
    ...
    'calidad', 'desccalidad', 'interpretacion', 'imgUrls'
  ],
  data() {
    return {
  ...
  mounted() {
    ...
    console.log('Props from ViewMuestras2:', this.calidad, this.desccalidad, this.interpretacion, this.imgUrls);
  },
  methods: {
    submitForm() {
